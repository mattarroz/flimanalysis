...
gnuplot_setstyle (gnuplot_ctrl * h, char *plot_style)
{
  if (strcmp (plot_style, "lines") &&
      ...
      strcmp (plot_style, "boxes") && strcmp (plot_style, "boxerrorbars"))
    {
...
gnuplot_plot_once (char *title,
		   char *style,
		   char *label_x, char *label_y, double *x, double *y, int n)
{
  gnuplot_ctrl *handle;
...
void
gnuplot_plot_slope (gnuplot_ctrl * handle, double a, double b, char *title)
{

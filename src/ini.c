...
int ReadCfg(const char *FileName, char *SectionName, struct CfgStruct *MyVars, FILE *CfgFile)
{
//      FILE *CfgFile;
...
//      CfgFile = cant((char *)FileName, "r");
      ...
      while (EOF != ReadLine(CfgFile, line))
      {
            ...
            case InSection:              /* In our section, parse it. */
            {
                  ...
                  for (mv = MyVars, i=0; i < 1; i++) //mv->Name ,++mv
                  {
